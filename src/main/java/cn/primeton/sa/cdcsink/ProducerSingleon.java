...
public class ProducerSingleon {
    ...
    public static Producer getProducer(String clusterIp, String topic, String key, String message) {
        if (producer == null) {
            synchronized (ProducerSingleon.class) {
                if (producer == null) {
                    producer = initProducer(clusterIp, topic, key, message);
                }
            }
        }
        return producer;
    ...
    private static Producer initProducer(String clusterIp, String topic, String key, String message) {
